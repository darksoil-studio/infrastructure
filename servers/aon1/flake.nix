{
  ...
  inputs = {
    ...
    demo-launcher.url = "github:darksoil-studio/demo-launcher/v0.2.11";
              ...
              "${machineName}" = cachix-deploy-lib.nixos {
                ...
                in {
                  systemd.services.aon1 = {
                    ...
                    serviceConfig = {
                      ExecStart =
                        "${aon}/bin/always-online-node --data-dir /root/aon1/v0.2.11 --bootstrap-url ${bootstrapServerUrl} --signal-url ${signalServerUrl}";
                  ...
                  systemd.services.aon2 = {
                    ...
                    serviceConfig = {
                      ExecStart =
                        "${aon}/bin/always-online-node --data-dir /root/aon2/v0.2.11 --bootstrap-url ${bootstrapServerUrl} --signal-url ${signalServerUrl}";
                      RuntimeMaxSec = "3600"; # Restart every hour
